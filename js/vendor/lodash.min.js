...
;(function () {
  ...
  ;(Pr[ot] = Pr[ft] = Pr[ct] = Pr[at] = Pr[lt] = Pr[st] = Pr[ht] = Pr[pt] = Pr[_t] = !0),
    (Pr[Bn] = Pr[Tn] = Pr[ut] = Pr[Dn] = Pr[it] = Pr[Mn] = Pr[Nn] = Pr[Pn] = Pr[Zn] = Pr[
      Kn
    ] = Pr[Gn] = Pr[Yn] = Pr[Qn] = Pr[Xn] = Pr[rt] = !1)
  var qr = {}
  ;(qr[Bn] = qr[Tn] = qr[ut] = qr[it] = qr[Dn] = qr[Mn] = qr[ot] = qr[ft] = qr[ct] = qr[
    at
  ] = qr[lt] = qr[Zn] = qr[Kn] = qr[Gn] = qr[Yn] = qr[Qn] = qr[Xn] = qr[nt] = qr[st] = qr[
    ht
  ] = qr[pt] = qr[_t] = !0),
    (qr[Nn] = qr[Pn] = qr[rt] = !1)
  var Zr = {
    ...
    ve = function p(x) {
      ...
      function Ee(n, t, r, e, u, i) {
        ...
        if (h && !l)
          return (
            i || (i = new dr()), o || Ah(n) ? si(n, t, r, e, u, i) : hi(n, t, c, r, e, u, i)
          )
        if (!(r & an)) {
      ...
      function ei(n) {
        return function (t, r) {
          return (
            ('string' == typeof t && 'string' == typeof r) || ((t = kc(t)), (r = kc(r))),
            n(t, r)
          )
        }
      }
      ...
      function ea(n, t, r) {
        return (
          (t = xc(t)), r === Y ? ((r = t), (t = 0)) : (r = xc(r)), (n = kc(n)), xe(n, t, r)
        )
      }
      function ua(n, t, r) {
        if (
      ...
      var Rs = vl ? rc : Na,
        ...
        Ts = ru(function (n) {
          var t = mo(n),
            r = c(n, mu)
          return (
            t === mo(r) ? (t = Y) : r.pop(), r.length && r[0] === n[0] ? je(r, bi(t, 2)) : []
          )
        }),
        $s = ru(function (n) {
          var t = mo(n),
